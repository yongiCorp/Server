...
public class MemberMissionController {
    ...
    @Parameter(name = "memberId", description = "회원의 Id는 Path Variable 입니다")
    @GetMapping("/users/missions/{memberId}")
    public ApiResponse<MemberMissionResponseDto.GetMemberMissionDto> getMission(@PathVariable Long memberId) {
